...
export default async function handler(req, res) {
  ...
  const emailHtml = [
    ...
    '<div style="max-width:500px;margin:32px auto;background:#fff;border-radius:12px;overflow:hidden">',
    ...
    '<div><h2 style="margin:0;font-size:18px;color:#111">Orden iniciada</h2>',
    '<p style="margin:0;font-size:13px;color:#6b7280">Ajuste en proceso</p></div>',
    '</div>',
